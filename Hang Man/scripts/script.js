const wordDisplay=document.querySelector(".word-disp");
...
const getRandomWord = () => {
    //Selecting a random word hint frrom a word list
...
const gameover=(isVictory) => {
    ...
    setTimeout(() => {
        const modalText = isVictory ? `You found the word:` : `The Correct wprd was:`;
...
const initGame = (button, clickedLetter) =>{
    //checking if current word exists on the current word
